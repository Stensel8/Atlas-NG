...
<p align="center">
  ...
  •
  <a href="https://atlasos.net/docs/" target="_blank">📚 Documentation</a>
  •
...
- [Installation](https://atlasos.net/docs/install/playbook/)
- [Install FAQ](https://atlasos.net/docs/faq/installation/#what-was-removed-from-windows)
- [General FAQ](https://atlasos.net/docs/faq/general/#security-and-atlasos)
- [Contribution Guidelines](https://atlasos.net/docs/contributing/)
- [Branding](https://atlasos.net/docs/branding/)

## 🤔 What is Atlas?

AtlasOS, or Atlas, is an open-source project that enhances Windows by conveniently applying privacy, usability, and performance optimizations, all while maintaining functionality and [customizability](https://atlasos.net/docs/atlas-configuration/settings/).
...
### 🛡️ Security Features
Most Windows modifications remove key security features most users need to maintain a secure system. On the other hand, Atlas allows users to customize their security at their own risk while informing users about each option's [pros and cons](https://atlasos.net/docs/atlas-configuration/security/).
...
## 🎨 Brand kit
Want to create your own Atlas wallpaper with some original creative designs? Visit our [Branding Kit on Docs](https://atlasos.net/docs/branding/) and share your creations on our [GitHub Discussions](https://github.com/Atlas-OS/Atlas/discussions/categories/community-artwork)!
